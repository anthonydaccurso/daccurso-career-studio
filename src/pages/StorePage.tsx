...
function StorePage() {
  useEffect(() => {
    ...
    const timer = setTimeout(() => {
      // Force HTTPS and ensure proper URL format
      const storeUrl = 'https://daccurso-career-studio-shop.fourthwall.com/';
      console.log('Redirecting to:', storeUrl); // For debugging
